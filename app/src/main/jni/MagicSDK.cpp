...
JNIEXPORT void JNICALL Java_com_fycoder_fy_beauty_utils_MagicSDK_jniInitMagicBeauty(
        JNIEnv *env, jobject obj, jobject handle) {
    LOGE("调用MagicSDK.CPP中的jniInit");
...
JNIEXPORT void JNICALL Java_com_fycoder_fy_beauty_utils_MagicSDK_jniStartWhiteSkin(
        JNIEnv *env, jobject obj, jfloat whiteLevel) {
    MagicBeauty::getInstance()->startWhiteSkin(whiteLevel);
}

JNIEXPORT void JNICALL Java_com_fycoder_fy_beauty_utils_MagicSDK_jniStartSkinSmooth(
...
JNIEXPORT void JNICALL Java_com_fycoder_fy_beauty_utils_MagicSDK_jniUninitMagicBeauty(
        JNIEnv *env, jobject obj) {
    MagicBeauty::getInstance()->unInitMagicBeauty();
}

JNIEXPORT jobject JNICALL Java_com_fycoder_fy_beauty_utils_MagicSDK_jniStoreBitmapData(
        JNIEnv *env, jobject obj, jobject bitmap) {
    return BitmapOperation::jniStoreBitmapData(env, obj, bitmap);
}

/**free bitmap*/
JNIEXPORT void JNICALL Java_com_fycoder_fy_beauty_utils_MagicSDK_jniFreeBitmapData(
        JNIEnv *env, jobject obj, jobject handle) {
...
Java_com_fycoder_fy_beauty_utils_MagicSDK_jniGetBitmapFromStoredBitmapData(
        JNIEnv *env, jobject obj, jobject handle) {
